...
namespace CyrillicAny
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddScoped<ISearchedQueriesRepository, SearchedQueriesRepository>();
			services.AddScoped<ISearchQueriesService, SearchQueriesService>();
